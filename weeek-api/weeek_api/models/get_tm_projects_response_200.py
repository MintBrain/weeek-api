...
T = TypeVar("T", bound="GetTmProjectsResponse200")


@_attrs_define
class GetTmProjectsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_tm_projects_response_200 = cls(
            success=success,
            projects=projects,
        )

        get_tm_projects_response_200.additional_properties = d
        return get_tm_projects_response_200
