...
T = TypeVar("T", bound="PostTmTasksResponse200")


@_attrs_define
class PostTmTasksResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_tm_tasks_response_200 = cls(
            success=success,
            task=task,
        )

        post_tm_tasks_response_200.additional_properties = d
        return post_tm_tasks_response_200
