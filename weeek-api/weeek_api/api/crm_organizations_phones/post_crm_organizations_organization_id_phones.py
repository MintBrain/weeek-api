...
from ...models.post_crm_organizations_organization_id_phones_body import PostCrmOrganizationsOrganizationIdPhonesBody
...
def _get_kwargs(
    organization_id: str,
    *,
    body: PostCrmOrganizationsOrganizationIdPhonesBody,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/crm/organizations/{organization_id}/phones",
    }
