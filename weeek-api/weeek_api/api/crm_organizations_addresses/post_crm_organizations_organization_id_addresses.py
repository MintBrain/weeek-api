...
from ...models.post_crm_organizations_organization_id_addresses_body import (
...
def _get_kwargs(
    organization_id: str,
    *,
    body: PostCrmOrganizationsOrganizationIdAddressesBody,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/crm/organizations/{organization_id}/addresses",
    }
