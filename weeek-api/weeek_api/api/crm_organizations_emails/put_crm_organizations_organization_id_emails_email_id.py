...
from ...models.put_crm_organizations_organization_id_emails_email_id_body import (
...
def _get_kwargs(
    ...
    email_id: str,
    *,
    body: PutCrmOrganizationsOrganizationIdEmailsEmailIdBody,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/crm/organizations/{organization_id}/emails/{email_id}",
    }
